      ...
      if ($this->session->flashdata('success') != null)
        {
          if($this->session->flashdata('success')){
            $alert_class = "success";
            $alert_text = "Congratulations, the article was deleted successfully.";
          }else{
            $alert_class = "danger";
        ...
        <tbody>
          ...
          foreach($articles as $row)
          {
            ...
            echo '<td class="crud-actions">
              <a href="'.site_url().'/articles/view/'.$row['id'].'" class="btn btn-primary">view</a> 
              <a href="'.site_url().'/articles/edit/'.$row['id'].'" class="btn btn-success">edit</a> 
            </td>';
            echo '</tr>';
          }
          ?>      
