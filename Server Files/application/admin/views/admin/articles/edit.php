<div class="container top">
  ...
  <div class="page-header users-header">
    ...
    <h2>
      ...
      <a  href="<?php echo site_url()."/articles/view/".$article['id'];?>" class="btn btn-success" style="float:right;">View</a>
    </h2>
	...
	<form action="<?php echo site_url('articles/save/'.$article['id']);?>" method="post">
		<?php
		...
		?>
		<p>
			<input type="text" class="form-control input-lg" name="title" placeholder="Title of the article" value="<?php echo $article['title'];?>">
		</p>
		<p>
